...
module CofreeBot.Bot.Behaviors.Jitsi.Dictionary where

import qualified Data.Vector as V
import qualified Data.Text as T

pluralNouns :: V.Vector T.Text
pluralNouns = [
    ...
    "T.Texts", "Strips", "Strokes", "Structures", "Struggles", "Students",
